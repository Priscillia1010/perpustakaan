...
Route::get('/petugass/detail/{id}', [PetugasController::class, 'show'])->name('petugass.show');
...
Route::get('/petugass/search', [PetugasController::class, 'search'])->name('petugass.search');
...
Route::get('/anggotas/detail/{id}', [AnggotaController::class, 'show'])->name('anggotas.show');
...
Route::get('/bukus/detail/{id}', [BukuController::class, 'show'])->name('bukus.show');
...
Route::get('/raks/detail/{id}', [RakController::class, 'show'])->name('raks.show');
...
Route::get('/raks/search', [RakController::class, 'search'])->name('raks.search');
